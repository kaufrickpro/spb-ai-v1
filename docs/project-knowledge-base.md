...
- Next recommended step: verify the full local upload -> queued job -> processor dispatch -> processed/failed document loop end to end against the local Supabase project, then harden retry/backoff and operator ergonomics before production Cloud Tasks wiring.
