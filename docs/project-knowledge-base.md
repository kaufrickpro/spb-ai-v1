...
- Next recommended step: run the documented local Supabase smoke path with real local services and then add the real document scanner integration slice before real staging/production user uploads.
